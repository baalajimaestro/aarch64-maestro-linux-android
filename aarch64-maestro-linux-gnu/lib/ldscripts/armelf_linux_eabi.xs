...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/cb_an_ano17004/x-tools/aarch64-maestro-linux-gnu/aarch64-maestro-linux-gnu/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
